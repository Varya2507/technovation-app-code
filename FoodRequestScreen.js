...
export default class FoodRequestScreen extends Component{
  ...
  addRequest =(foodName,reasonToRequest)=>{
          ...
          <MyHeader title="Request Food" navigation ={this.props.navigation}/>
            <KeyboardAvoidingView style={styles.keyBoardStyle}>
              ...
              <TextInput
                ...
                multiline
                numberOfLines ={8}
                placeholder={"With which organization are you associated?"}
                onChangeText ={(text)=>{
                    this.setState({
              ...
              <TouchableOpacity
                style={styles.button}
                onPress={()=>{this.addRequest(this.state.foodName,this.state.reasonToRequest)}}
                >
                <Text>Request</Text>
              </TouchableOpacity>
            </KeyboardAvoidingView>
